...
//Smooth transition in between div's 
...
containerTabs.addEventListener('click', function(btn) {
  
  const clicked = btn.target.closest('.operations__tab');
...
const lazingLoading = function(entries, observer) {
  const [ entry ] = entries;
...
const imagesObserver = new IntersectionObserver(lazingLoading,
{
  root: null,
  threshold: 0,
  rootMargin: "200px",
